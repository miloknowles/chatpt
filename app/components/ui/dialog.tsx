  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Popup
        ...
        className={cn(
          "fixed top-1/2 left-1/2 z-50 grid w-full max-w-lg -translate-x-1/2 -translate-y-1/2 gap-4 border bg-popover p-6 text-popover-foreground shadow-lg duration-200 data-ending-style:zoom-out-95 data-starting-style:zoom-in-95 sm:rounded-lg",
          className
        )}
        {...props}
      />
